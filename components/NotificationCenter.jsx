    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                ...
                >
                    {/* Header Popover */}
                    <div className="p-4 border-b border-slate-100 bg-linear-to-r from-slate-50/90 via-white to-slate-50/90">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                <div className="w-8 h-8 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center text-sm shadow-xs">
                    ...
                    <div className="max-h-[380px] overflow-y-auto divide-y divide-slate-100 custom-scrollbar p-2 space-y-1">
                            ...
                            displayedNotifications.map(item => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* Quick Actions (Mark read / dismiss) on hover */}
